    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="space-y-2">
        <div className="flex gap-2">
          <input value={domain} onChange={(e) => setDomain(e.target.value)} className="flex-1 border rounded px-3 py-2" />
          <button onClick={runTrace} className="px-3 py-2 rounded bg-gray-900 text-white">Trace</button>
          <button onClick={startLogs} className="px-3 py-2 rounded bg-gray-200">Stream Logs</button>
        </div>
      ...
      <div>
        <h3 className="font-medium mb-2">Watcher Lo
